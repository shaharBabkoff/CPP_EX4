...
TEST_CASE("String")
{
    SUBCASE("k=2")
    {
        ...
        SUBCASE("errors")
        {
            // Add error tests here if needed
        }
    }
    ...
    SUBCASE("k=4")
    {
        Node<string> root_node("a"); // k=4
        Tree<string, 4> tree;        // 4-ary tree that contains strings.
        tree.add_root(root_node);
        Node<string> n_b("b");
        Node<string> n_c("c");
        Node<string> n_d("d");
...
TEST_CASE("double")
{
    ...
    SUBCASE("k=4")
    {
        Node<double> root_node(1.1); // k=4
        Tree<double, 4> tree;        // 4-ary tree that contains doubles.
        tree.add_root(root_node);
        Node<double> n_b(1.2);
        Node<double> n_c(1.3);
        Node<double> n_d(1.4);
...
TEST_CASE("Complex")
{
    ...
    SUBCASE("k=4")
    {
        Node<Complex> root_node(Complex(1, 1)); // k=4
        Tree<Complex, 4> tree;        // 4-ary tree that contains Complex numbers.
        tree.add_root(root_node);
        Node<Complex> n_b(Complex(2, 2));
        Node<Complex> n_c(Complex(3, 3));
        Node<Complex> n_d(Complex(4, 4));
